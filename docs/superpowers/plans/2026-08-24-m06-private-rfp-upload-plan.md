...
- [ ] **Step 3: Check the CLI contract and create the migration through Supabase CLI**
...
- [ ] **Step 4: Reset and verify the schema contract is GREEN**
...
- [ ] **Step 1: Write synthetic real-role behavior tests**
...
- [ ] **Step 3: Add minimum document policies and audit trigger behavior**
...
- [ ] **Step 4: Reset and verify document behavior is GREEN**
...
- [ ] **Step 5: Commit the document authorization behavior**
...
- [ ] **Step 1: Extend the runtime-only synthetic fixture without exposing secrets**
...
- [ ] **Step 2: Write the failing real Storage behavior test**
...
- [ ] **Step 3: Run the targeted Storage test and capture RED**
...
- [ ] **Step 4: Add operation-specific Storage policies**
...
- [ ] **Step 5: Reset and verify real Storage behavior is GREEN**
...
- [ ] **Step 1: Write failing unit behavior tests**
...
- [ ] **Step 2: Run targeted Vitest and capture RED**
...
- [ ] **Step 3: Implement the minimum Web-runtime-compatible helpers and provider**
...
- [ ] **Step 4: Re-run targeted Vitest for GREEN and commit**
...
- Create: `src/app/projects/[projectId]/rfp/route.ts`
...
- [ ] **Step 4: Re-run browser behavior for GREEN and commit**
...
- [ ] **Step 1: Write and run the targeted accessibility behavior**
...
- [ ] **Step 2: Run the fresh affected verification set**
...
- [ ] **Step 3: Self-review the M06 diff**
...
- [ ] **Step 4: Persist evidence and commit coherent records**
