...
| STAGE_GATE_M08 | WAITING | User must explicitly authorize M08 Requirement Extraction | M07 is complete and the user required every milestone transition to stop at its Gate | An explicit instruction to proceed with M08 | M07 evidence commit is clean; M08 remains `NOT_STARTED` |
