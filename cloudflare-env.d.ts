/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 86b188da31aea83dbdbde4472a327cbf)
// Runtime types generated with workerd@1.20260820.1 2026-08-20 global_fetch_strictly_public
interface __BaseEnv_CloudflareEnv {
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* m01-next-scaffold */;
}
